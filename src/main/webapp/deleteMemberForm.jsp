            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-lg-8 col-md-7">
                        <div class="card">
                            <div class="header">
                                <h4 class="title">정말 탈퇴 하시겠습니까?</h4>
                            </div>
                            <div class="content">
                                <form action="<%=request.getContextPath()%>/deleteMemberAction.jsp" method="post">
	                                <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label>비밀번호</label>
                                                <input type="password" class="form-control border-input" name="memberPw" value="">
                                            </div>
                                        </div>
                                    </div>
									...
									%>
                                    <div class="text-center">
                                        <button type="submit" class="btn btn-danger btn-fill btn-wd">탈퇴 확정</button>
                                    </div>
